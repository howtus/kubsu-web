...
<head>
    ...
    <title>Задание 6 | Мешари Д.</title>
...
<form id="form" action="" method="POST">
    ...
    <div class="field">
        ...
        <div class="control">
            <input id="nameInput" class="input <?php if ($errors['name']) print 'is-danger'; else print 'is-primary' ?>"
                   type="text" name="name" placeholder="Ваше имя" value="<?php print $values['name']; ?>"/>
        </div>
    ...
    <div class="field">
        ...
        <div class="control">
            <input id="emailInput"
                   class="input <?php if ($errors['email']) print 'is-danger'; else print 'is-primary' ?>" type="email"
                   name="email" placeholder="Ваше Email" value="<?php print $values['email']; ?>"/>
        </div>
        ...
        <div class="control">
            ...
            <label class="radio">
                <input type="radio" name="sex"
                       value="female" <?php if ($values['sex'] == 'female') print(' checked'); ?> />
                Женский
            </label>
        </div>
    </div>
    ...
    <div class="field">
        ...
        <div class="control">
            <textarea id="bioText" name="bio"
                      class="textarea <?php if ($errors['bio']) print 'is-danger'; else print 'is-primary' ?>"
                      placeholder="Напишите здесь немного о себе..."><?php print $values['bio']; ?></textarea>
        </div>
    ...
    <div class="field is-grouped">
        <div class="control">
            <button name="btn" type="submit" class="btn button is-primary" value="ok">Отправить</button>
        </div>
    </div>
    <!-- ./Button -->
</form>
